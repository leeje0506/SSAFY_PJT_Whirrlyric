            ...
            <div className="flex justify-end">
                ...
                <div className="">
                    ...
                    <button data-modal-target="static-modal" data-modal-toggle="static-modal"
                            ...
                            type="button" onClick={clickGuide}>
                        {guideIcon}
                    </button>
                    <div id="static-modal" data-modal-backdrop="static" aria-hidden="true"
                         className={`${modalVisible ? '' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-50 right-0 left-50 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
            ...
            <div>
                <form onSubmit={handleSubmit} className="w-full">
                    ...
                    <div className="flex-col my-6">
                        <div>
                            <select className="w-full border-solid bg-gray-200 text-2xl font-['Pretendard'] font-extrabold" name="genre">
                        ...
                        <div>
                            <input type="submit" value="Done" className="mx-auto my-6 text-center text-3xl font-['Pretendard'] font-extrabold bg-black text-white rounded-2xl w-full"/>
                        </div>
                    </div>
                </form>
            </div>
